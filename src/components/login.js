    ...
    const handleOnSubmit = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                sessionStorage.setItem("usertype", 'Placecell');
                    ...
                    <div className="submit">
                        <form onSubmit={handleOnSubmit}>
                            ...
                            <div className="password-input" style={{  color: "white" }}>
                                ...
                                <br></br>
                                <Link style={{float:"right",color:"violet"}} className="this-link" to='/forgotpwd' >Forgot Password?</Link>
                            </div>
                            <button className='btn' >Log in</button>

                            <p >
                                New user?<Link style={{color:"violet"}}  className="this-link" to='/signup' >Sign up</Link>
                            </p>
                        </form>
                    </div>
                </div>
